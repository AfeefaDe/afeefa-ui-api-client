...
export default class Relation {
    ...
    getAll(params) {
        ...
        return query ? query.getAll(params) : Promise.resolve([]);
    }
    save(model) {
        const query = this.getQuery();
        return query ? query.save(model) : Promise.resolve(null);
    }
    delete(model) {
        const query = this.getQuery();
        return query ? query.delete(model) : Promise.resolve(null);
    }
